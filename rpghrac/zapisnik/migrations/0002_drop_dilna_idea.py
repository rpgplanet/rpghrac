...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for category in orm['core.Category'].objects.filter(tree_path='dilna'):
            root_category = orm['core.Category'].objects.get(tree_path='', site=category.site)

            for article in orm['core.Publishable'].objects.filter(category = category):
    ...
    def backwards(self, orm):
        ...
        raise RuntimeError("We can create Dilna again, but what is the point if we don't know which articles were in it?")
    ...
    complete_apps = ['core', 'sites', 'auth', 'articles', 'zapisnik']
